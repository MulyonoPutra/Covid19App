...
class ConfirmedCaseScreen extends StatefulWidget {
  @override
  _ConfirmedCaseScreenState createState() => _ConfirmedCaseScreenState();
}

class _ConfirmedCaseScreenState extends State<ConfirmedCaseScreen> {
  @override
  void initState() {
    super.initState();
              ...
              child: Wrap(
                  ...
                  children: data.map((e) {
                    return DetailCard(
                      ...
                      effectedNum: e.attributes.kasusPosi.toString(),
                      press: () {},
                    );
                  }).toList()),
            ),
